...
export default function splash ({ path, name, org, coc, logo, active, total, channels, large, iframe }){
  let div = dom('.splash',
    ...
    dom('p.barefootcoders',
      'Brought to you by your friends at ',
      dom(`a href=http://barefootcoders.com target=_top`, 'Barefoot Coders'),
      '. Come find us in B19, on the third floor, with any of your software needs. We also play Catan and Avalon...',
    ),
    !iframe && dom('footer',
      'powered by ',
